...
const winChecker = () => {
    ...
    for(let i of winningPattern) {
        ...
        //Checked if element are filled
        //IF 3 empty elements are same and would gives win as would
        if(element1 != "" && (element2 != "") & (element3 != "")) {
            if (element1 == element2 && element2 == element3) {
                //if all 3 buttons have same value then pass the value of winFunction
